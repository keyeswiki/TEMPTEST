...
https://pan.baidu.com/s/1Mn7TDF2QDLJYgV7oH0z2ig?pwd=keye
...
以下区域为程序功能拼接区域。将功能块从左侧块区拖入程序建构区进行拼接。该区域的右下角有个垃圾桶，可以将不用的代码拖进去删除，也可以将不用的代码直接往最左方拖拽（模块选择区），同样可以删除代码。当然，点击不用的代码后点击键盘
...
4\.
读取的模拟值赋给变量A0，数字值赋给变量D0，串口监视器显示两个变量的值，中间我们用空给隔开。（我们默认设置为9600，可更改）。
...
6\.
![](media/bec2587fbb85a8ef98c67c8cb7236638.png)代码块的编程方法其实我们在前面的实验中有讲过，在光折断计数实验中，忘记了可以回顾一下。
...
![](media/ac0d6049bc0a5ae8cc515d23b85ecad0.png)微处理器与
...
![](media/4b53b42cc41010d1e2214115acc69ff3.png)
...
![](media/3ee71212f849dc22207e834f59725b4a.png)
...
|![](media/587b80e6014873f575a5bb11ad83d7ac.png)|![](media/74c381d3196f281a59c81b7139bef121.png)|![](media/bd91d78384c61a15404744920239fbe6.png)|![](media/5f2390a733dd67eaf5375eb2de59c7c0.png)|![](media/a9a7938da6f59aefa989e7f44a1c5afe.png)|
...
|![](media/48c54454d3ed2a582052384d253c291b.png)|![](media/8fe8a0c065b41b035fbb3f597e1c8cc6.png)|![](media/38e7b1050bccce7ad148a309e89daba0.png)|![](media/278ab2c9abc0ef47df1129df9ff790fd.png)|![](media/464ca968e2520ecc9cb7f5afbdcb7e1a.png)|
...
![](media/6ff158fb4d0d675733aa4db596b23182.png)
...
![](media/1b1e72f6d49612c5aa0091759953879e.png)
